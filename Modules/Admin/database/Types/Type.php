...
namespace Modules\Admin\database\Types;

use Doctrine\DBAL\Platforms\AbstractPlatform as DoctrineAbstractPlatform;
use Doctrine\DBAL\Types\Type as DoctrineType;
use Modules\Admin\database\Platforms\Platform;
...
abstract class Type extends DoctrineType
{
    ...
    public static function toArrayLama(DoctrineType $type)
    {
    ...
    public static function toArray(DoctrineType $type)
    {
        ...
        // Ambil nama via static registry
        $name = array_search(get_class($type), Type::getTypesMap(), true);
    ...
    public static function registerCustomPlatformTypes($force = false)
    {
        ...
        $platformName = ucfirst(getDatabasePlatformName());
